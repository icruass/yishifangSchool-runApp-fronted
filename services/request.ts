...
/*
根据项目扩展uni.request.
自动根据请求方式设置传值的key, eg: post --> key is data; get --> key is params
*/
const dataKeyMapMethod = {
	'POST': 'data',
	'GET': 'params',
}
...
export const extendUniRequest = async (options : ExtendRequestOptions) : RequestResult => {
	...
	const dataKey = dataKeyMapMethod[options.method] || 'params';

	const _options : RequestOptions = {
		[dataKey]: options.params,
		...restOptions,
