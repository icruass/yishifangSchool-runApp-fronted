<template>
	<UniEasyInput :value='userName' :styles="styles" :placeholder='placeholder' :primaryColor='primaryColor'
...
<script setup lang="ts">
	...
	const component_uiConfig = uiConfig['login-userName-input'];
	...
	const input = (val : any) => {
		useLoginStore.setState({ userName: val });
	};
